                        ...
                        <div class="col-md-4 text-center mb-4">
                            <div class="position-relative">
                                @if ($user->profile_image)
                                    <img id="profileImage" src="{{ asset('storage/photos/' . $user->profile_image) }}"
                                        class="img-fluid rounded-circle shadow-lg"
                                        style="width: 120px; height: 120px; object-fit: cover; border: 3px solid #f8f9fa;">
                                @else
                                    <img id="profileImage" src="{{ asset('/public/img/polinema-bw.png') }}"
                                        class="img-fluid rounded-circle shadow-lg"
                                        style="width: 120px; height: 120px; object-fit: cover; border: 3px solid #f8f9fa;">
                                @endif
                            </div>
                            ...
                            <form method="POST" action="{{ route('profil.update', $user->user_id) }}" enctype="multipart/form-data">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input id="profile_image" type="file" class="form-control shadow-sm"
                                        name="profile_image" onchange="uploadProfileImage(this)">
                                </div>
...
<script>
    function uploadProfileImage(input) {
        ...
        .then(data => {
            if (data.success) {
                document.getElementById('profileImage').src = '/storage/photos/' + data.file_name;
